...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (countyvotes > winningcounty_count) and (countyvotes_percentage > winningcounty_percentage):
            winningcounty_count = countyvotes
            winning_county = county_name
            winningcounty_percentage = countyvotes_percentage

    # 7: Print the county with the largest turnout to the terminal.
    winning_county_summary = (
        f"-------------------------\n"
        f"largest County Turnout: {winning_county}\n"
        f"Percentage & Vote Count: {winningcounty_percentage:.1f}% ({winningcounty_count:,})\n"
        f"-------------------------\n"
        f"Candidate:\n")
